...
//页面加载完毕后,取出关联的市场活动信息列表
	...
	//为关联市场活动模态窗口中 搜索框绑定事件,通过触发回车 查询活动列表
		$("#aname").keydown(function (event) {
			...
			if (event.keyCode==13){
				...
				$.ajax({
					url : "clues/activity/getActivityListByNameAndNotByClueId.do",
					data : {
	...
	function showActivityList() {
		...
		$.ajax({
			url : "clues/activity/getActivityListByClueId.do",
			data : {
