	...
	function changeStage(stage,i) {
		...
		$.ajax({
			...
			success : function (data) {
				...
				//data succuss： true/false 阶段 可能性 修改人 修改时间（封装到t对象） "t":{交易}

				if (data.success){
            //成功改变阶段 局部刷新 刷新阶段 可能性 修改人 修改时间
...
*/
	//如果当前阶段的可能性为0 前七个一定是个黑圈,后两个一个是红叉,一个是黑叉
...
%>
		...
		<%
				...
				//可能性不为0 前七个有可能是绿圈,绿色标记,黑圈,后两个一定是黑叉
			}else {
