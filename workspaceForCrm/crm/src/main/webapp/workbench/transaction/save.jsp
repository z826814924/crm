...
%>
	...
	alert(json);
	//阶段和可能性是一一对应的关系 可以想象成键值对之间的关系 阶段为key 触发性为value
	//key           value
	//01资质审查    10
	//02资质审查    25 。。。。
	//结论 数据量不是很大 这是一种键值对关系
	//如果同时满足以上两种 保存在数据库就没意义了
	//如果遇到这种情况,我们需要用到properties属性文件进行保存
	//stage2Possibility.properties
	//01资质审查=10
	//02xxx=25
	//stage2Possibility.properties这个文件表示键值对和阶段的对应关系
	//这种东西在交易模块中大量使用,我们需要把文件解析在缓存中
	...
	$(function () {
		...
		$("#create-stage").change(function () {
			...
			//将pMap java中的键值对 转换成js中的键值对


			//json.stage不能取value stage是动态的 要使用的取值方式为json[key]
...
<option value="${s.value}">${s.text}</option>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="056bb9c0de61476386c96e224d720505"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="ceaf3569cc5846aaae74829b92cd1a77"/>
			</div>
		</div>
