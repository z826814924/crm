...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	$(function(){
		...
		$("#addBtn").click(function () {
			...
			//走后台,目的是为了取得用户信息列表,为为所有者下拉框铺值
			$.ajax({
				url : "work/activity/getUserList.do",
				type : "get",
				dataType : "json",
		...
		$("#saveBtn").click(function () {
			$.ajax({
				...
				*/
				...
				$("#activityAddForm").reset();无效
					注意：
					我们拿到了form表单中的jquery对象
	...
	/*	$("input[name=xz]").click(function () {
		...
		//因为动态生成的元素,是不能以普通以普通绑定事件的形式来进行操作的
		/*
		...
		*/
		...
		$("#deleteBtn").click(function () {
			...
			if ($xz.length==0){
				...
				if(confirm("确定删除所选的记录吗")){
					//url : work/activity/delete.do?id=xxx&id=xxx$=xxx
		...
		$("#editBtn").click(function () {
			...
			if ($xz.length==0){
				...
				$.ajax({
					url : "work/activity/getUserListAndActivity.do",
					data : {
						"id" : id
					},
					type : "get",
    ...
    pageList方法:就是发出ajax请求到后台,从后台取得最新的市场活动信息列表数据
            ...
            我们都在那些情况下,需要调用pageList方法(什么情况下需要刷新一下市场活动列表)
	...
	function pageList(pageNo,pageSize) {
		...
		$.ajax({
			...
			success : function (data) {
				...
				html +='<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'work/activity/detail.do?id='+n.id+'\'">'+n.name+'</a></td>';
				html +='<td>'+n.owner+'</td>';
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 81%;">
								...
								我们所以的对于textarea的取值和赋值操作,虽然没有balue属性但是应该统一使用val()方法（而不是html（）方法）
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 5px;">
				<div class="btn-group" style="position: relative; top: 18%;">
					...
					data-target="#createActivityModal":表示将要打开哪个模态窗口,通过#id的形式找到该窗口
