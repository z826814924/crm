	...
	$(function(){
      ...
      //页面加载完毕之后，展现该市场活动关联的备注信息列表
		...
		$("#saveRemarkBtn").click(function () {
			...
			$.ajax({
				url : "work/activity/saveRemark.do",
				data : {
		...
		$("#updateRemarkBtn").click(function () {
			...
			$.ajax({
				url : "work/activity/updateRemark.do",
				data : {
...
function showRemarkList() {
	...
	$.ajax({
		url : "work/activity/getRemarkListByAid.do",
		data : {
			"activityId" : "${a.id}"
...
function deleteRemark(id) {
	...
	$.ajax({
		url : "work/activity/deleteRemark.do",
		data : {
			"id" : id
		},
		type : "post",
	...
	function editRemark(id) {
		...
		//打开模态窗口前找到指定的存放备注信息的h5标签
		var noteContent= $("#e"+id).html();

		//将h5中展现出来的信息,赋予到修改模态窗口的文本域中
